...
<section class="page-title-area text-white bg_cover"
    style="background-image: url(assets/images/bg/page-bg-1.jpg); padding: 30px 0;">
    <div class="container">
        ...
        <div class="row">
            <?php if (!empty($tours_list)): ?>
                <?php foreach ($tours_list as $tour): ?>
                    <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                        <div class="single-place-item wow fadeInUp shadow-sm h-100 bg-white"
                            ...
                            <div class="place-img" style="height: 250px; position: relative;">
                                ...
                                <button class="wishlist-btn-listing <?php echo $tour['is_wishlisted'] ? 'active' : ''; ?>"
                                    ...
                                    <i class="fa<?php echo $tour['is_wishlisted'] ? 's' : 'r'; ?> fa-heart"
                                        style="color: <?php echo $tour['is_wishlisted'] ? '#F7921E' : '#888'; ?>; font-size: 18px;"></i>
                                </button>
                            </div>
                            <div class="place-content p-4">
                                <div class="info">
                                    <h4 class="title mb-2"><a href="tour-details.php?id=<?php echo $tour['id']; ?>"
                                            class="text-dark text-decoration-none"
                                            style="font-weight: 700;"><?php echo htmlspecialchars($tour['title']); ?></a></h4>
                                    <p class="location mb-3 text-muted" style="font-size: 14px;"><i
                                            class="fas fa-map-marker-alt me-1 text-primary"></i><?php echo htmlspecialchars($tour['destination']); ?>
                                    </p>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="price">
                                            ...
                                            <span
                                                class="fw-bold text-primary h5 mb-0">₹<?php echo number_format($tour['price']); ?></span>
                                        </div>
                                        <div class="meta text-muted small">
                                            <span><i
                                                    class="far fa-clock me-1"></i><?php echo htmlspecialchars($tour['duration']); ?>
                                                Days</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-grid">
                                        <a href="tour-details.php?id=<?php echo $tour['id']; ?>"
                                            class="btn btn-outline-primary rounded-pill btn-sm py-2">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    <img src="assets/images/no-results.png" alt="No products" style="width: 150px; opacity: 0.3;"
