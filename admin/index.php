...
$bookings_count = $conn->query("SELECT COUNT(*) FROM bookings")->fetch_row()[0] ?? 0;
...
$recent_bookings = $conn->query("SELECT b.*, u.name as user_name FROM tour_bookings b LEFT JOIN users u ON b.user_id = u.id ORDER BY b.id DESC LIMIT 5");
?>
                    ...
                    <tbody>
                        <?php if($recent_bookings && $recent_bookings->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['user_name'] ?? 'Guest'; ?></td>
                                <td><?php echo $row['tour_title'] ?? 'N/A'; ?></td>
