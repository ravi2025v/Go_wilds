                ...
                <div class="container">
                    <div class="primary-menu black-bg px-0">
                        ...
                        <div class="site-brading ">
                            <a href="index-3.php" class="brand-logo"><img src="assets/images/logo-black.png" alt="Logo"></a>
                        </div>
                        <!--====== Nav Menu ======-->
						<!--<div class="mobile-logo mb-30">
                             <a href="index.php" class="brand-logo"><img src="assets/images/logo/logo-black.png" alt="Site Logo"></a>
                        </div>-->
                    ...
                    <div class="col-lg-12 order-1 order-lg-2">
                        ...
                        <div class="wow fadeInDown text-justify" id="policy">
                            <div class="section-title text-center mb-30 wow fadeInUp">
                                <h2 class="pt-2">Terms & Conditions</h2>
                            </div>
                            <p>
								This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various
								statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.</p>
							<p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and
							regulations, privacy policy and Terms of Use for access or usage of domain name www.myeasytrip.in ('Website'), including the related mobile site and mobile application (hereinafter
							referred to as 'Platform').</p>
							<p>The Platform is owned by Abhiteja Tourism Solutions Private Limited, a company incorporated under the Companies Act, 1956 with its registered office at 86-26-15-20,Tilak Road,
							Rajamahendravaram, AP 533103 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
							<p>Your use of the Platform and services and tools are governed by the following terms and conditions (“Terms of Use”) as applicable to the Platform including the applicable policies which
							are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform,
							You shall be contracting with the Platform Owner and these terms and conditions including the policies constitute Your binding obligations, with Platform Owner. These Terms of Use relate to
							your use of our website, goods (as applicable) or services (as applicable) (collectively, 'Services').Any terms and conditions proposed by You which are in addition to or which conflict with these
							Terms of Use are expressly rejected by the Platform Owner and shall be of no force or effect. These Terms of Use can be modified at any time without assigning any reason. It is your
							...
							<p>The use of Platform and/or availing of our Services is subject to the following Terms of Use:
								<ol>
									<li>To access and use the Services, you agree to provide true, accurate and complete information to us during and after registration, and you shall be responsible for all acts done through the
									use of your registered account on the Platform..</li>
									<li>Neither we nor any third parties provide any warranty or guarantee as to the accuracy,timeliness, performance, completeness or suitability of the information and materials offered
										on this website or through the Services, for any specific purpose. You acknowledge that such information and materials may contain inaccuracies or errors and we expressly exclude
									    liability for any such inaccuracies or errors to the fullest extent permitted by law..</li>
									<li>Your use of our Services and the Platform is solely and entirely at your own risk and discretion for which we shall not be liable to you in any manner. You are required to
										independently assess and ensure that the Services meet your requirements..</li>
									<li>The contents of the Platform and the Services are proprietary to us and are licensed to us.You will not have any authority to claim any intellectual property rights, title, or interest in
									...
									<li>You agree and acknowledge that website and the Services may contain links to other third party websites. On accessing these links, you will be governed by the terms of use, privacy
										policy and such other policies of such third party websites. These links are provided for your convenience for provide further information..</li>
									...
									<li>You shall indemnify and hold harmless Platform Owner, its affiliates, group companies (as applicable) and their respective officers, directors, agents, and employees, from any claim or
										demand, or actions including reasonable attorney's fees, made by any third party or penalty imposed due to or arising out of Your breach of this Terms of Use, privacy Policy and other
										Policies, or Your violation of any law, rules or regulations or the rights (including infringement of intellectual property rights) of a third party.</li>
									...
									<li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Rajahmundry and Andhra Pradesh.</li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="footer-widget about-company-widget mb-40">
								...
								<a href="#" class="footer-logo"><img src="assets/images/logo-white.png" alt="Site Logo"></a>
                                    <p class="pt-4">To take trivial example which us ever undertakes laborious physica exercise except obsome.</p>
                        ...
                        <div class="col-lg-2 col-md-6">
                            ...
                            <div class="footer-widget service-nav-widget mb-40 pl-lg-20">
                                ...
                                <div class="footer-content">
                                    <ul class="footer-widget-nav w-100">
                                        <li><a href="about.php">About us</a></li>
						...
						<div class="col-lg-3 col-md-6">
                            ...
                            <div class="footer-widget about-company-widget mb-40 pl-lg-20">
                                ...
                                <div class="footer-content">
									...
									<p>Email Address<br>
									support@myeasytrip.in</p>

									<p>Visit office<br>
									86-26-15/20, Tilak Road, Rajahmundry - 533103, Andhra Pradesh.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <div class="footer-text">
                                <p>Copyright @ 2025 <span style="color: #F7921E;">MyEasyTrip</span>, All Right Reserved</p>
                            </div>
